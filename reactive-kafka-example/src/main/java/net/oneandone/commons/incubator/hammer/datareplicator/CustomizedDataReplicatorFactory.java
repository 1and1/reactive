 ...
 */
package net.oneandone.commons.incubator.hammer.datareplicator;
...
import net.oneandone.commons.incubator.neo.datareplicator.DataReplicator.DataReplicatorFactorySpi;


class CustomizedDataReplicatorFactory extends DataReplicatorFactorySpi {
    
    protected DataReplicator newDataReplicator(final URI uri) {
        return super.newDataReplicator(uri)
