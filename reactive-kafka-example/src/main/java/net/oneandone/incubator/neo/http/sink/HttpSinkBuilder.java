...
public interface HttpSinkBuilder {
     ...
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withClient(final Client client);

    /**
     * @param method the method. Supported are POST and PUT (default is {@link HttpSinkBuilder#DEFAULT_METHOD})
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withMethod(final Method method);
    
    /**
     * @param retryPauses the delays before retrying (default is {@link HttpSinkBuilder#DEFAULT_RETRY_PAUSES})
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withRetryAfter(final ImmutableList<Duration> retryPauses);
    
    /**
     * @param retryPauses the delays before retrying (default is {@link HttpSinkBuilder#DEFAULT_RETRY_PAUSES})
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withRetryAfter(final Duration... retryPauses);
     ...
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withRetryParallelity(final int numParallelWorkers);
     ...
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withRetryBufferSize(final int bufferSize);
     ...
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withRetryPersistency(final File dir);
     ...
     * @return a new instance of the http sink
     */
    HttpSinkBuilder withRejectOnStatus(final ImmutableSet<Integer> rejectStatusList);
